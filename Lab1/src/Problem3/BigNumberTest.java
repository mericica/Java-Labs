...
public class BigNumberTest {
    ...
    public void sumTestFalse(){
        ...
        int[] array1 = new int[]{4, 2, 2};
        int[] array2 = new int[]{5, 7, 9};
        int[] unexpectedResult = new int[]{2, 0, 0, 1};
        assert Arrays.equals(b1.sum(array1, array2), unexpectedResult);
    ...
    public void diffTestFalse(){
        ...
        int[] array1 = new int[]{4, 2, 2};
        int[] array2 = new int[]{5, 7, 9};
        int[] unexpectedResult = new int[]{1, 4, 7};
        assert Arrays.equals(b1.diff(array1, array2), unexpectedResult);
    ...
    public void mulTestFalse(){
        ...
        int[] array3 = new int[]{1, 2, 2};
        int digit = 2;
        int[] unexpectedResult = new int[]{2, 4};
        assert Arrays.equals(b1.mul(array3, digit), unexpectedResult);
    ...
    public void divTestFalse(){
        ...
        int[] array3 = new int[]{1, 2, 2};
        int digit = 2;
        int[] unexpectedResult = new int[]{1, 6, 1};
        assert Arrays.equals(b1.div(array3, digit), unexpectedResult);
    }
}
