...
public class GradesTest {
    ...
    public void notSuffGradesTestWrong(){
        int[] result = g1.notSufficiantGrades(grades);
        assert result[0] == 55;
        assert result[1] == 44;
    }

    public void averageTestWrong(){
        assert (g1.average(grades) == 50);
    }
    public void roundedGradesTestWrong(){
        int[] result = g1.roundArray(grades);
        assert result[0] == 88;
    }

    public void maxGradeTestWrong(){
        assert (g1.maxGrade(grades) == 45);
    }
}
